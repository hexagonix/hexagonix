...
O Hexagonix também ganhou um port do montador [Fasm](https://flatassembler.net/index.php), permitindo ao usuário desenvolver aplicativos diretamente no Hexagonix/Andromeda.
